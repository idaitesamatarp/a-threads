...
const ActionType = {
  TOGGLE_UP_VOTE_THREAD: 'thread/TOGGLE_UP_VOTE',
  TOGGLE_DOWN_VOTE_THREAD: 'thread/TOGGLE_DOWN_VOTE',
  TOGGLE_NEUTRAL_VOTE_THREAD: 'thread/TOGGLE_NEUTRAL_VOTE',
  TOGGLE_UP_VOTE_COMMENT: 'comment/TOGGLE_UP_VOTE',
  TOGGLE_DOWN_VOTE_COMMENT: 'comment/TOGGLE_DOWN_VOTE',
  TOGGLE_NEUTRAL_VOTE_COMMENT: 'comment/TOGGLE_NEUTRAL_VOTE',
};
